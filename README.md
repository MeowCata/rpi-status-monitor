...
Your folder tree may be like this:
```
/home/<username>
  /rpi-monitor
    app.py
...
```
Congrats! Now load this address on your `Cloudflare Tunnel` and check it on your domain!
...
2.Less than 5M tokens are used, costing only ~2.1 CNY, so cheap!

3.Using `ZRAM` for swap is recommended if you don't wanna exert your poor SD card and let it die when still young
